...
if (isset($_GET["id"])) {
    ...
    if ($security[1] == $_SESSION["admin"]->token_user) {
        $select = "tipo,datos,generacion_anterior,generacion_actual,reduccion";
        $url = "aumentos_generaciones_residuos?select=" . $select . "&linkTo=id&equalTo=" . $security[0];
        $method = "GET";
        $fields = array();
        ...
        if ($response->status == 200) {
            ...
            echo '<script>
			    window.location = "/aumento_de_generacion_residuos";
            </script>';
        }
    } else {
        echo '<script>
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Aumento de generación de residuos</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/">Principal</a></li>
                    <li class="breadcrumb-item"><a href="/aumento_de_generacion_residuos">Aumento de generación de residuos</a></li>
    ...
    <div class="container-fluid mb-2">
        <div class="card card-dark card-outline">
            <form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                <input type="hidden" value="<?php echo $security[0] ?>" name="idAumentoGeneracionResiduos">
                <div class="card-header">
                    <?php
                    require_once "controllers/aumento.generacion.residuos.controller.php";

                    $edit = new AumentoGeneracionResiduosController();
                ...
                <div class="card-footer">
                    <div class="col-md-8 offset-md-2">
                        <div class="form-group mt-3">
                            <a href="/aumento_de_generacion_residuos" class="btn btn-light border text-left">Volver</a>
