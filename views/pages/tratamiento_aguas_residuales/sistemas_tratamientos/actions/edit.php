...
if (isset($_GET["id"])) {
    ...
    if ($security[1] == $_SESSION["admin"]->token_user) {
        ...
        $url = "sistemas_tratamientos?select=" . $select . "&linkTo=id&equalTo=" . $security[0];
        $method = "GET";
        $fields = array();
        ...
        if ($response->status == 200) {
            ...
            echo '<script>
			    window.location = "/sistemas_tratamientos";
            </script>';
        }
    } else {
        echo '<script>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="/sistemas_tratamientos">Sistema de tratamiento</a></li>
    ...
    <div class="container-fluid mb-2">
        <div class="card card-dark card-outline">
            <form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                <input type="hidden" value="<?php echo $security[0] ?>" name="idSistemaTratamiento">
                <div class="card-header">
                    <?php
                    require_once "controllers/sistema.tratamiento.controller.php";

                    $edit = new SistemaTratamientoController();
                ...
                <div class="card-footer">
                    <div class="col-md-8 offset-md-2">
                        <div class="form-group mt-3">
                            <a href="/sistemas_tratamientos" class="btn btn-light border text-left">Volver</a>
