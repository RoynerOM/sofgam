        ...
        <div class="card card-dark card-outline">
            <form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                <div class="card-header">
                    ...
                    $create = new ConsumoAguaController();
                    $create->create();
                    ?>
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group mt-5">
                            <label>Area</label>
                            <input type="text" class="form-control" pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚ ]{1,}" onchange="validateJS(event,'t&n&e')" name="area" required>
                        ...
                        <div class="form-group mt-2">
                            <label>Nise</label>
                            <input type="number" class="form-control" name="nise" required>
                            <div class="valid-feedback">Válido.</div>
                            <div class="invalid-feedback">Por favor rellene este campo.</div>
                        </div>
                        <!--=====================================
