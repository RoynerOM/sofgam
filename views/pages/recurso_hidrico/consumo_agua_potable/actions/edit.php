...
if (isset($_GET["id"])) {
    ...
    if ($security[1] == $_SESSION["admin"]->token_user) {
        $select = "area,nise,anio,enero,febrero,marzo,abril,mayo,junio,julio,agosto,septiembre,octubre,noviembre,diciembre,total";
        $url = "consumos_agua_potable?select=" . $select . "&linkTo=id&equalTo=" . $security[0];
        $method = "GET";
        $fields = array();
        ...
        if ($response->status == 200) {
            ...
            echo '<script>
			    window.location = "/consumo_agua_potable";
            </script>';
        }
    } else {
        echo '<script>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="/consumo_agua_potable">Consumo de agua potable</a></li>
    ...
    <div class="container-fluid mb-2">
        <div class="card card-dark card-outline">
            <form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                <input type="hidden" value="<?php echo $security[0] ?>" name="idConsumoAgua">
                <div class="card-header">
                    <?php
                    require_once "controllers/consumo.agua.controller.php";

                    $edit = new ConsumoAguaController();
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="form-group mt-2">
                            <label>Año</label>
                            <input type="date" class="form-control" value="<?php echo $result->anio ?>" name="anio" required>
                            <div class="valid-feedback">Válido.</div>
                            <div class="invalid-feedback">Por favor rellene este campo.</div>
                        </div>
                        <!--=====================================
                ...
                <div class="card-footer">
                    <div class="col-md-8 offset-md-2">
                        <div class="form-group mt-3">
                            <a href="/consumo_agua_potable" class="btn btn-light border text-left">Volver</a>
