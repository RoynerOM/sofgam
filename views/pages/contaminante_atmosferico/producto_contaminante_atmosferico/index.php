        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Productos contaminantes atmosfericos</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid mb-2">
        ...
        <div class="card mb-5">
            <div class="card-header">
                <h3 class="card-title">
                    <a class="btn bg-dark btn-sm" href="/producto_contaminante_atmosferico_new">Nuevo registro</a>
                </h3>
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <table id="adminsTable" class="table table-bordered table-striped tableProductoContaminante">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Nombre</th>
                            <th>Actividad</th>
                            <th>Contaminanción</th>
                            <th>Presentación</th>
