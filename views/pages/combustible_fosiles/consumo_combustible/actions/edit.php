...
if (isset($_GET["id"])) {
    ...
    if ($security[1] == $_SESSION["admin"]->token_user) {
        $select = "tipo,enero,febrero,marzo,abril,mayo,junio,julio,agosto,septiembre,octubre,noviembre,diciembre,total";
        $url = "consumos_combustibles?select=" . $select . "&linkTo=id&equalTo=" . $security[0];
        $method = "GET";
        $fields = array();
        ...
        if ($response->status == 200) {
            ...
            echo '<script>
			    window.location = "consumo_combustible";
            </script>';
        }
    } else {
        echo '<script>
    ...
    <div class="container-fluid mb-2">
        <div class="card card-dark card-outline">
            <form method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                <input type="hidden" value="<?php echo $security[0] ?>" name="idConsumoCombustible">
